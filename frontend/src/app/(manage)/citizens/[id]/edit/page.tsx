        ...
        <form onSubmit={handleSubmit} className="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input required name="hoTen" value={formData.hoTen} onChange={handleChange} className="w-full p-3 bg-gray-50 border-none rounded-xl font-black focus:ring-2 focus:ring-blue-500" />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Ngày sinh *</label>
                <input required type="date" name="ngaySinh" value={formData.ngaySinh} onChange={handleChange} className="w-full p-3 bg-gray-50 border-none font-black rounded-xl focus:ring-2 focus:ring-blue-500" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Giới tính *</label>
                <select name="gioiTinh" value={formData.gioiTinh} onChange={handleChange} className="w-full p-3 bg-gray-50 border-none rounded-xl focus:ring-2 font-black focus:ring-blue-500">
            ...
            <div>
              ...
              <input name="soCCCD" value={formData.soCCCD} onChange={handleChange} className="w-full p-3 bg-gray-50 border-none rounded-xl focus:ring-2 font-black focus:ring-blue-500" />
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input required name="householdId" value={formData.householdId} onChange={handleChange} className="w-full p-3 bg-gray-50 border-none rounded-xl font-black focus:ring-2 focus:ring-blue-500" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Quan hệ với chủ hộ *</label>
              <input required name="quanHeVoiChuHo" value={formData.quanHeVoiChuHo} onChange={handleChange} className="w-full p-3 bg-gray-50 border-none rounded-xl  font-black focus:ring-2 focus:ring-blue-500" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Nghề nghiệp</label>
              <input name="ngheNghiep" value={formData.ngheNghiep} onChange={handleChange} className="w-full p-3 bg-gray-50 border-none rounded-xl focus:ring-2 font-black focus:ring-blue-500" />
            </div>
          </div>
